...
from tgbot_client.consts import IMPL, ONEBOT_VERSION
...
class Config(BaseSettings):
    ...
    docs_title: Optional[str] = "TgUser工具箱"
    """`TgUser工具箱` 标题"""
    docs_version: Optional[str] = "0.0.1"
    """`docs`的版本"""
...
class Driver:
    ...
    def __init__(self, config: BaseConfig) -> None:
        ...
        self._server_app = FastAPI(
            ...
            title=self.fastapi_config.docs_title,
            description="Api接口文档",
            version=self.fastapi_config.docs_version,
    ...
    def run(
        ...
        **kwargs,
        ...
        LOGGING_CONFIG = {
            ...
            "handlers": {
                "default": {
                    "class": "tgbot_client.log.LoguruHandler",
                },
            },
            "loggers": {
